...
conn = psycopg2.connect (
    ...
    password="Jason.Chen241194",  # Byt ut med ditt lösenord
 
    port="5544"  # Byt ut med din port (oftast 5432 för PostgreSQL
...
csv_file_path = "Python för barn\sales_data.csv"  # Sökvägen till din CSV-fil
...
create_table_query = """
    ...
    CREATE TABLE IF NOT EXISTS ds11.sales (          
...
for index, row in df.iterrows():
    ...
    INSERT INTO ds11.sales (date, product, price, quantity)
    VALUES (%s, %s, %s, %s)
